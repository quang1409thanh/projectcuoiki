...
void Init_Bricklv1(Brick brick[]){
	vector<Point> lv1=load_Vector("source1/data/lv1.txt");
...
void Init_Bricklv2(Brick brick[]){
	vector<Point> lv2=load_Vector("source1/data/lv2.txt");
...
void Init_Bricklv3(Brick brick[]){
	vector<Point> lv3=load_Vector("source1/data/lv3.txt");
...
void Init_Bricklv4(Brick brick[]){
	vector<Point> lv4=load_Vector("source1/data/lv4.txt");
...
void Init_Bricklv5(Brick brick[]){
	vector<Point> lv5=load_Vector("source1/data/lv5.txt");
