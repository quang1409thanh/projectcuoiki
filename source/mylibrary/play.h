...
std::string playlv5()
{
	...
	while (!quit)
	{
		...
		if (count_Broken_Bricks == (TOTAL_BRICKSLV1 + TOTAL_BRICKSLV2 + TOTAL_BRICKSLV3 + TOTAL_BRICKSLV4 + TOTAL_BRICKSLV5 - 6) * 50)
		{ // chú ý sửa chỗ này
			quit = true;
			// return "quit";
			SDL_Delay(100);
...
std::string playlv4()
{
	...
	while (!quit)
	{
		...
		if (count_Broken_Bricks == (TOTAL_BRICKSLV1 + TOTAL_BRICKSLV2 + TOTAL_BRICKSLV3 + TOTAL_BRICKSLV4) * 50)
		{ // chú ý sửa chỗ này
			quit = true;
			// return "quit";
			SDL_Delay(100);
...
std::string playlv3()
{
	...
	while (!quit)
	{
		...
		if (count_Broken_Bricks == (TOTAL_BRICKSLV1 + TOTAL_BRICKSLV2 + TOTAL_BRICKSLV3) * 50)
		{ // chú ý sửa chỗ này
			quit = true;
			// return "quit";
			SDL_Delay(100);
...
std::string playlv2()
{
	...
	while (!quit)
	{
		...
		if (count_Broken_Bricks == (TOTAL_BRICKSLV1 + TOTAL_BRICKSLV2) * 50)
		{ // chú ý sửa chỗ này
			quit = true;
			// return "quit";
			SDL_Delay(100);
